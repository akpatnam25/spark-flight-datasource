...
public class Util {
  public static FlightSourceParams extractOptions(Map<String, String> options) {
    FlightSourceParams flightParams = new FlightSourceParams.FlightSourceParamsBuilder()
